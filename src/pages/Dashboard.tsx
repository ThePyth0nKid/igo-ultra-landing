    ...
    <LayoutWithSidebar>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <section className="bg-white/5 border border-gray-800 rounded-xl p-4 text-center shadow-xl">
          ...
          />
          <h2 className="text-xl font-ultra text-ultra-red mt-4">{user.ultra_name || user.username}</h2>
          <p className="text-xs text-gray-400">ID: {user.id}</p>
          <p className="text-sm text-gray-300">Lv. <span className="text-ultra-red">{user.level ?? 0}</span></p>
